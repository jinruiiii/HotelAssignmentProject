...
import Databases.ReservationsDB;
import Databases.RoomServiceDB;
...
import Entities.Reservation.ReservationStatus;
import Entities.Room.RoomStatus;
import Externals.CheckDate;
import Externals.CheckIfDouble;
import Externals.CheckIfInt;
import Externals.DateCheck;
import Externals.SerializingClass;
	                  ...
	                  // =================================== Adding in the printing of the reservation details if reservation is successful =============================//
	                        ...
	                        case 3: // printing guest's hotel bill invoice
	                            ...
	                            if(reservationsDB.getReservationFromReservationCode(reservationCode) == null) {
	                                ...
	                                System.out.printf(format, "============================", "================", "================", "================");
	                                if (roomServiceDB.getRsDB().get(reservationCode) != null) {
	                                	for (int i=0;i<roomServiceDB.getRsDB().get(reservationCode).size();i++) {
	                                    	roomServiceDB.getRsDB().get(reservationCode).get(i).printBill();
	                                    	totalPayment += roomServiceDB.getRsDB().get(reservationCode).get(i).getPayment();
	                                    }
	                                }
	                                System.out.println("========================================================");
                        	...
                        	while(roomCheck) {
	                        	...
	                        	switch(checkChoice) {
		                        	case 1:
		                                ...
		                                for (int i = 0; i<48; i++) {
		                                	if (roomNumber.equals(rooms.getRooms()[i].getRoomNum())) {
		                                	//Find the room status first
		                                	RoomStatus room_status = rooms.getRooms()[i].getStatus();
		                                	String available;
		                                    ...
		                                    System.out.printf(format, "================", "==================", "==================", "==================", "==================","==================");
		                                    System.out.printf(format,available,rooms.getRooms()[i].getRoomNum(),rooms.getRooms()[i].getRoomType(),rooms.getRooms()[i].getWifi(),rooms.getRooms()[i].getSmoking(),rooms.getRooms()[i].getView());
                                ...
                                for (int i=0; i<48;i++) {
                                	if (roomNumber.equals(rooms.getRooms()[i].getRoomNum())) {
                                		...
                                		while (update) {
	                                        ...
	                                        switch(choice1) {
		                                        case 1:
		                                        	System.out.println("Current room's Weekday rate: " + rooms.getRooms()[i].getWeekdayRate());
		                                        	System.out.println("Set Weekday Rate:");
		                                        	double weekdayRate = sc.nextDouble();		                                      	
		                                        	rooms.getRooms()[i].setWeekdayRate(weekdayRate);
		                                        	System.out.println("Updated room's Weekday rate: " + rooms.getRooms()[i].getWeekdayRate());
		                                        	break;
		                                        	
		                                        case 2:
		                                        	System.out.println("Current room's Weekend rate: " + rooms.getRooms()[i].getWeekendRate());
		                                        	System.out.println("Set Weekend Rate:");
		                                        	double weekendRate = sc.nextDouble();
		                                        	rooms.getRooms()[i].setWeekendRate(weekendRate);
		                                        	System.out.println("Updated room's Weekend rate: " + rooms.getRooms()[i].getWeekendRate());
		                                        	break;
